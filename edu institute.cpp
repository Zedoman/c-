...
class officer : public staff
{
      ...
      public:
           ...
           void show()
                       {
               cout<<" name "<<setw(15)<<"code"<<setw(15)<<"Category "<<endl<<name<<setw(10)<<code<<setw(15)<<grade<<endl;
          }
};
...
class regular:public typist
{
      ...
      float wage;
       ...
       void show()
        {
                cout<<"name"<<setw(16)<<"code"<<setw(15)<<"speed"<<setw(15)<<"wage"<<endl<<name<<setw(10)<<code<<setw(15)<<speed<<setw(15)<<wage<<endl;
        }
};
